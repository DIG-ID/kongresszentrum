 ...
 */
function kongresszentrum_before_main_content() {
	?>
...
add_action( 'before_main_content', 'kongresszentrum_before_main_content' );

/**
 * This function closes the main content.
 */
function kongresszentrum_after_main_content() {
	?>
...
add_action( 'after_main_content', 'kongresszentrum_after_main_content' );

/**
 * This function open the main sidebar content.
 */
function kongresszentrum_before_main_sidebar() {
	?>
...
add_action( 'before_main_sidebar', 'kongresszentrum_before_main_sidebar' );

/**
 * This function closes the main sidebar content.
 */
function kongresszentrum_after_main_sidebar() {
	?>
	</div>
	</aside><!-- #main-sidebar -->
	<?php
...
add_action( 'after_main_sidebar', 'kongresszentrum_after_main_sidebar' );


/**
 * This function opens the wrapper of all the content. px-md-0
 */
function kongresszentrum_open_wrapper() {
	?>
...
add_action( 'wrapper_open', 'kongresszentrum_open_wrapper' );

/**
 * This function closes the wrapper of all the content.
 */
function kongresszentrum_close_wrapper() {
	?>
					</div><!-- .row -->
			</div><!-- .container -->
		</main><!-- #main -->
...
add_action( 'wrapper_close', 'kongresszentrum_close_wrapper' );

/**
 * Get our socials from the theme customizer and display them.
 */
function kongresszentrum_socials() {
...
add_action( 'socials', 'kongresszentrum_socials' );
